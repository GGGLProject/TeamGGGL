...
<body>
   ...
   <div class="bg-2" style="height: 900px">
   ...
   <div class="bg-container">
      <div class="bg-3">
         <div class="text-center container">
            <div class="video_box">
               <h3 class="text-center" style="font-size: 40px; margin-bottom: 30px;">경기 하이라이트 영상</h3>
            </div>
            <br>
            <c:set var="doneLoop" value="false" />
            <c:forEach var="m_vo" items="${main_video }" varStatus="status">
               <c:if test="${not doneLoop}">
                  <div class="col-sm-4 main_video_box">
                     <iframe class="main_video" width="360" height="220"
                        src="https://www.youtube.com/embed/${m_vo.match_videokey }"
