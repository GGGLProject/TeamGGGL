				...
				<form method="post" action="event_insert_ok.do" id=frm
					...
					<div class="col-lg-6">
						...
						<table class="table table-hover">
							...
							<tr>
								<td class="text-center" colspan=2><img id="img"
									class="event-img" height=320 width=320></td>
							</tr>
							<tr>
					...
					<div class="col-lg-6">
						<table class="table event-table table-hover">
							...
							<tr>
								...
								<td width=90% class="text-left qna-td"><input class="input"
									type=text name=subject size=65 id="subject"></td>
							</tr>
							<tr>
