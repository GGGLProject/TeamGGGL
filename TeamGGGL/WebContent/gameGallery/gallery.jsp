	...
	<div id="middle_nav_menu">
		...
		<div class="middle_tab_container">
			...
			<div class="middle_tab_content" id="tab2">
				<div class="row qnarow gametable">
					<div class="row text-center">
						<figure class="snip1200" id="myImg20">
							<img id="modal20" src="lol_1.jpg" alt="lol" />
								<figcaption>
									<p>I say, if your knees aren't green by the end of the day,
										you ought to seriously re-examine your life.</p>
									<div class="heading">
						...
						<figure class="snip1200" id="myImg21">
							<img id="modal21" src="lol_2.jpg" alt="lol" />
								<figcaption>
									<p>The inside of my head was exploding with fireworks.
										Fortunately, my last thought turned out the lights when it left.</p>
									<div class="heading">
										<h2> 난<span>경리</span></h2>
									</div>
								</figcaption>
								<a href="#"></a>
						</figure>
